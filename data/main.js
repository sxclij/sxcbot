...
// モデルを取得
var model = genAI.getGenerativeModel({ model: 'models/gemini-1.5-flash' });
// gemini_gen関数の定義
var gemini_gen = function (prompt) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    prompt = 'Gemini 1.5 Flash について教えてください。';
                    return [4 /*yield*/, gemini_gen(prompt)];
                case 1:
